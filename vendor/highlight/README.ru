...
<link href="/vendor/icomoon/style.css" media="screen" rel="stylesheet" type="text/css" /><script src="/vendor/modernizr-custom.js" type="text/javascript"></script><!--[if IE]><link href="/stylesheets/ie.css" media="screen" rel="stylesheet" type="text/css" /><![endif]--><!--[if lt IE 9]><script src="//html5shim.googlecode.com/svn/trunk/html5.js" type="text/javascript"></script><![endif]--><title>競選系列網站 Guideline</title><meta content="競選系列網站 Guideline" name="keywords"><meta content="競選系列網站 Guideline" name="description"><meta content="競選系列網站 Guideline" property="og:title"><meta content="競選系列網站 Guideline" property="og:site_name"><meta content="http://localhost:3000" property="og:url"><meta content="http://localhost:3000/fb.png" property="og:image"><meta content="競選系列網站 Guideline" property="og:description"><meta content="website" property="og:type"><meta content="123456" property="fb:admins"></head><body class="off-canvas"><div class="page"><div class="header"><div class="header-inner"><div class="header-top"><h1 class="logo"><a href="#">點亮台灣設計規範 Web Design Guideline</a></h1><button class="menu-btn"><div class="menu-btn-line"></div></button></div><div class="menu off-canvas-menu"><button class="close-btn"><div class="close-btn-line"></div></button><div class="menu-title">目錄</div><ul class="menu-list"><li class="menu-list-item"><a class="menu-list-item-title smooth-scroll-link" href="#guideline-summary">規範說明</a></li><li class="menu-list-item"><a class="menu-list-item-title smooth-scroll-link" href="#color-guideline">色彩規範</a><ul class="menu-sub-list"><li class="menu-sub-list-item"><a class="smooth-scroll-link" href="#main-color">主色調</a></li><li class="menu-sub-list-item"><a class="smooth-scroll-link" href="#dark-color">深色調</a></li><li class="menu-sub-list-item"><a class="smooth-scroll-link" href="#strong-color">醒目、強調色調</a></li></ul></li><li class="menu-list-item"><a class="menu-list-item-title smooth-scroll-link" href="#icon">Icon</a><ul class="menu-sub-list"><li class="menu-sub-list-item"><a class="smooth-scroll-link" href="#tawain-city-icon">台灣縣市 Icon</a></li></ul></li><li class="menu-list-item"><a class="menu-list-item-title smooth-scroll-link" href="#button">Button</a><ul class="menu-sub-list"><li class="menu-sub-list-item"><a class="smooth-scroll-link" href="#default-button">Default Button</a></li><li class="menu-sub-list-item"><a class="smooth-scroll-link" href="#primary-button">Primary Button</a></li><li class="menu-sub-list-item"><a class="smooth-scroll-link" href="#danger-button">Danger Button</a></li></ul></li><li class="menu-list-item"><a class="menu-list-item-title smooth-scroll-link" href="#form">Form</a><ul class="menu-sub-list"><li class="menu-sub-list-item"><a class="smooth-scroll-link" href="#input">Input</a></li><li class="menu-sub-list-item"><a class="smooth-scroll-link" href="#select">Select</a></li><li class="menu-sub-list-item"><a class="smooth-scroll-link" href="#form-groups">Form Groups</a></li></ul></li><li class="menu-list-item"><a class="menu-list-item-title smooth-scroll-link" href="#component">Component</a><ul class="menu-sub-list"><li class="menu-sub-list-item"><a class="smooth-scroll-link" href="#pagination">Pagination</a></li><li class="menu-sub-list-item"><a class="smooth-scroll-link" href="#card">Card</a></li><li class="menu-sub-list-item"><a class="smooth-scroll-link" href="#member">Member</a></li></ul></li></ul></div><div class="off-canvas-mask"></div></div></div><h1 id="highlightjs">Highlight.js</h1>
